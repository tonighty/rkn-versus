...
(0, _jquery2.default)(document).ready(function () {
	(0, _jquery2.default)('.layout-item').eq(randomInteger(0, 10)).addClass('active');
});

(0, _jquery2.default)('.layout-item').hover(function () {
	if ((0, _jquery2.default)(this).hasClass('active')) {
		var $el = (0, _jquery2.default)('.layout-item'),
		    limit = 3,
		    $elLength = $el.length,
		    randEl;
